...
class OrdersTest extends TestCase
{
     ...
     * @depends testit_returns_an_order_details_data
     */
    public function testit_returns_an_order_cartonpack_optional_itemnumber_listing_data($params)
    {
        $response = $this->json('POST', '/api/order/cartonpack?token='.$this->token, ['order_no' => $params['order_number']]);
     ...
     * @depends testit_returns_an_order_details_data
     */
    public function testit_returns_an_order_cartonpack_with_itemnumber_listing_data($params)
    {
        $response = $this->call('POST', '/api/order/cartonpack?token='.$this->token, ['order_no' => $params['order_number'],'item_number' => $params['item_number']]);
     ...
     * @depends testit_returns_an_order_details_data
     */
    public function testit_returns_an_order_cartonloose_optional_itemnumber_listing_data($params)
    {
        $response = $this->call('POST', '/api/order/cartonloose?token='.$this->token, ['order_no' => $params['order_number']]);
     ...
     * @depends testit_returns_an_order_details_data
     */
    public function testit_returns_an_order_cartonloose_with_itemnumber_listing_data($params)
    {
        $response = $this->call('POST', '/api/order/cartonloose?token='.$this->token, ['order_no' => $params['order_number'],'item_number' => $params['item_number']]);
