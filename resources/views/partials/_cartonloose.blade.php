	...
	@foreach ($data['cartonloose'] as $cartonloose)
		...
		<?php $i++; ?>
			...
			@endif
					...
					<div class="third-row">
						<div class="barcode">
							<img src="data:image/png;base64,{{DNS1D::getBarcodePNG($cartonloose['productindicatorbarcode'], 'C128',1,60)}}" alt="barcode" /><br/>
							{{$cartonloose['productindicator']}}
						</div>
					</div>
					<div class="fourth-row">
						<div class="barcode">
							<img src="data:image/png;base64,{{DNS1D::getBarcodePNG($carton['barcode'], 'C128',1,60)}}" alt="barcode" /><br/>
							{{$carton['number']}}
						</div>
					</div>
				</div>
